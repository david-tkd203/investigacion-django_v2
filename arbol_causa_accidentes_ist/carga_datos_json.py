...
from accidentes.constants import (
...
def upsert_usuarios(records: List[Dict[str, Any]]) -> Tuple[int, int, List[str], List[str]]:
    ...
    for idx, r in enumerate(records, 1):
        ...
        is_staff = rol_val.startswith("admin") or rol_val in (ROLE_INVESTIGADOR_IST, ROLE_ADMIN_IST)
        is_superuser = (rol_val == ROLE_SUPER_ADMIN)
